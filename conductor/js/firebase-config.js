...
function initializeDriverStatus() {
  ...
  // Si la app cierra de golpe o pierde señal, Firebase marca la unidad como
  // offline desde el servidor. Usamos update (no remove) para no perder el
  // historial ni desaparecer del mapa ante micro-cortes de señal.
